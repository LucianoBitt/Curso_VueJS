<template>
	<div id="app" class="container-fluid">
		...
		<hr>
		<button variant="primary" @click="componenteSelecionado = 'AlertaInfo'">Info</button>
		<button variant="primary" @click="componenteSelecionado = 'AlertaAdvertencia'">Advertência</button>
	</div>
</template>
